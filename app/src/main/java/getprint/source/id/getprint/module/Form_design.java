 ...
 */
public class Form_design extends DrawerActivity {
    private String img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        balik.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Form_design.this, Design.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form_design.this, Order.class);
                intent.putExtra("img", String.valueOf(img));
                intent.putExtra("label", String.valueOf(label));
                intent.putExtra("sizeName", "6cm");
                intent.putExtra("price", "Rp.45.000,-/100pcs");
